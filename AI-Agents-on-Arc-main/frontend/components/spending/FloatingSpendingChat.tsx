...
import { X, MessageCircle, ChevronDown, Zap } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";
import { SpendingChat } from "./SpendingChat";

interface FloatingSpendingChatProps {
  userId: string;
  isEnabled: boolean;
}

export function FloatingSpendingChat({
  userId,
  isEnabled,
