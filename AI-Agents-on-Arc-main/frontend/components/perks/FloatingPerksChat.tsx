...
import { X, MessageCircle, ChevronDown, Gift } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";
import { PerksChat } from "./PerksChat";

interface FloatingPerksChatProps {
  userId: string;
  isEnabled: boolean;
  perksData: any;
}

export function FloatingPerksChat({
  userId,
  isEnabled,
  perksData,
}: FloatingPerksChatProps) {
