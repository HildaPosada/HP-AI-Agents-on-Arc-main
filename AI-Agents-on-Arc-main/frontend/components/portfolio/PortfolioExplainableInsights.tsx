              ...
              <div key={asset.name}>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-[#ccff00]">{asset.percentage}%</p>
                  </div>
                </div>

                {/* Progress bar */}
                <div className="w-full h-3 bg-[#0f0f0f] rounded-full overflow-hidden border border-[#ccff00]/20">
                  <div
            ...
            <div className="mt-6 pt-6 border-t border-[#ccff00]/10">
              <div className="flex items-center justify-between p-4 rounded-lg bg-[#ccff00]/5">
                <div>
                  ...
                  <p className="text-3xl font-bold text-[#ccff00]">$196,500</p>
                </div>
                <div className="text-right">
